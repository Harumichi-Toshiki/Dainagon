...
GRAPH_SAVE_PATH = "model/learning_curve_v28_fine2.png" 
...
POSITIONS_PER_EPOCH = 7_436_270  # 1エポックあたりの局面数（1億局面）
SHUFFLE_BUFFER_SIZE = 100_000      # シャッフルバッファ（大きくするとより混ざる。50万件で約19MB）
