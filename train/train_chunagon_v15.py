...
MODEL_SAVE_PATH = "model/chunagon_v15.pt" 
GRAPH_SAVE_PATH = "model/learning_curve_v15.png" 
...
TOTAL_STEPS_PER_EPOCH = 38000000 // PHYSICAL_BATCH_SIZE 
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        for i, (x, t_m, t_v, move_count) in enumerate(pbar):
            ...
            # 80手目以降の重み付け
            loss_v = ((v.squeeze() - t_v)**2 * torch.where(move_count > 80, 2.0, 1.0)).mean()
